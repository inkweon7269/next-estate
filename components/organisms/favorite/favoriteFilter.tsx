                            ...
                            <div style={{
                                ...
                                <div style={{ display: 'flex', alignItems: 'center' }}>
                                    <Paragraph style={{ marginRight: 15 }}>매매: <Text
                                        type='danger'>{dealType(item.deals, 'BUY').length}</Text>건</Paragraph>
                                    <Paragraph style={{ marginRight: 15 }}>전세: <Text
                                        type='danger'>{dealType(item.deals, 'RENT').length}</Text>건</Paragraph>
                                    <Paragraph style={{ marginRight: 15 }}>전세가율 <Text type='danger'>{rentRate(dealType(item.deals, 'RENT'), dealType(item.deals, 'BUY'))}</Text></Paragraph>
                                    <SelectField
                                        placeholder='평수'
                                        options={item.areas}
                                        style={{ width: 80 }}
